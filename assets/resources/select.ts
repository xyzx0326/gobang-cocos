...
export class select extends Component {
    ...
    onLoad() {
        if (this.isShadow) {
            ...
            g.circle(0, 0, 4);
            g.fill();
            g.arc(0, 0, 18, 0, 1 / 5 * Math.PI, true);
            g.arc(0, 0, 18, 2 / 5 * Math.PI, 3 / 5 * Math.PI, true);
            g.arc(0, 0, 18, 4 / 5 * Math.PI, 5 / 5 * Math.PI, true);
            g.arc(0, 0, 18, 6 / 5 * Math.PI, 7 / 5 * Math.PI, true);
            g.arc(0, 0, 18, 8 / 5 * Math.PI, 9 / 5 * Math.PI, true);
